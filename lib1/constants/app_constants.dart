...
class AppConstants {
  ...
  static String getLeftHandImage(String character) {
    ...
    // Gujarati - Left Ring
    if (['ૈ', 'ે', 'ઃ', 'ઐ', 'એ', 'ઁ'].contains(character)) {
      return leftRingImage;
    }
  ...
  static String getRightHandImage(String character) {
    ...
    // Hindi characters - Right Pinky
    if (['ड', '़', 'ॉ', 'ट', 'ढ', 'ञ', 'ठ'].contains(character)) {
      return rightPinkyImage;
    }
    // Hindi - Right Ring
    ...
    // Gujarati characters - Right Pinky
    if (['ડ', '઼', 'ૉ', 'ટ', 'ઢ', 'ઞ', 'ઠ'].contains(character)) {
      return rightPinkyImage;
    }
    // Gujarati - Right Ring
    ...
    if (['હ', 'ગ', 'ર', 'ક', 'સ', ',', 'ઙ', 'ઘ', 'ખ'].contains(character)) {
      return rightIndexImage;
    }
