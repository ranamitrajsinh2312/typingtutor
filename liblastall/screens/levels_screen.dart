...
class _LevelsScreenState extends State<LevelsScreen>
  ...
  void _initializeControllers() {
    ...
    // Apply the initial language passed from dashboard
    if (widget.initialLanguageCode != _levelsController.currentLanguage) {
      _levelsController.changeLanguage(widget.initialLanguageCode);
    }
