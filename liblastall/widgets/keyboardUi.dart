...
class ModernKeyboardWidget extends StatelessWidget {
  ...
  /// Indic char → English physical key letter (e.g. {'ौ': 'q'}). Empty for English.
  ...
  Widget _buildKey(BuildContext context, String keyText, Color keyColor, bool isHomeRow) {
    ...
    // Tiny English sub-label for Indic keyboards
    final bool isIndic = languageCode != 'en';
    final String? subLabel =
        isIndic && !isSpecialKey && keyText != 'SPACE'
            ? (indicToPhysical[keyText]?.toUpperCase())
            : null;

    final Color mainTextColor = _getTextColor(keyColor, isRequired, isCurrentKey, isWrong, isSpecialKey, isHighlighted);
              ...
              children: [
                ...
                if (subLabel != null && subLabel.isNotEmpty)
                  Text(
                    subLabel,
                    style: TextStyle(
                      color: mainTextColor.withOpacity(0.60),
                      fontSize: 7,
                ...
                if (isHomeRow && !isSpecialKey && keyText != 'SPACE' && !isIndic)
                  Container(
